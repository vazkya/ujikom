<template>
  <div class="container">
    <div>
    <img src="~/assets/img/sejarah.jpg" alt="sejarah" style="width: 100%; height: auto; margin-top: 100px;" class="img-fluid" />
    <div class="m-5">
      <h3> sejarah </h3>
...
<script setup>
useHead({title: "sejarah", meta: [{nama: "sejarah", content: "HALAMAN SEJARAH"}]});
</script>